...
Debug_target.BIN = bin/Debug/tests_sc.exe
Debug_target.OBJ = main_sc3.o 
DEP_FILES += sc/main_sc3.d 
...
Debug_target : INCLUDES += -I../../../../Parvicursor -I/root/devel/systemc-2.3.1/src
Debug_target : RCFLAGS += 
Debug_target : LDFLAGS += -s -lsystemc -L/root/devel/systemc-2.3.1/buildtree/bin/lib-linux64
