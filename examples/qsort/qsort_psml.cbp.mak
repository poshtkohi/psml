...
Debug_target.BIN = bin/Debug/qsort_psml.exe
Debug_target.OBJ = CorePartitioner.o main_psml.o qsort_psml.o tb_qsort_psml.o 
DEP_FILES += CorePartitioner.d main_psml.d qsort_psml.d tb_qsort_psml.d 
...
Debug_target : LDFLAGS += -s -lpthread -luuid -ldl -lm -lcryptopp   
