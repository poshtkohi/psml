...
Debug_target.BIN = bin/Debug/manycore_psml.exe
Debug_target.OBJ = core_partitioner.o main_psml.o pe_matmul_psml.o pe_work_stealing_scheduler_psml.o 
DEP_FILES += core_partitioner.d main_psml.d pe_matmul_psml.d pe_work_stealing_scheduler_psml.d 
...
Debug_target : LDFLAGS += -s -lpthread -luuid -ldl -lm -lcryptopp -L../../../psml/bin/Debug/ -L../../../xSim2Lib/bin/Debug/ -L../../../ParvicursorLib/bin/Debug/ -L../../../Parvicursor/System.Threading/Thread/   
