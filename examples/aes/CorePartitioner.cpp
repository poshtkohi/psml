...
namespace Parvicursor
{
	namespace psml
	{
		...
		//----------------------------------------------------
		CorePartitioner::CorePartitioner(std::vector<psml_core *> *cores)
		{
			if(cores == null)
		...
		//----------------------------------------------------
		CorePartitioner::~CorePartitioner()
		{
		}
		//----------------------------------------------------
		PartitionInfo *CorePartitioner::Partition(Vector<LogicalProcess *> *objects, UInt32 &numberOfPartitions)
		{
			if(objects == null)
