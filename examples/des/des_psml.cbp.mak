...
Debug_target.BIN = bin/Debug/des_psml.exe
Debug_target.OBJ = psml/CorePartitioner.o psml/des.o psml/key_gen.o psml/main.o psml/round.o psml/s1.o psml/s2.o psml/s3.o psml/s4.o psml/s5.o psml/s6.o psml/s7.o psml/s8.o psml/tb.o 
DEP_FILES += psml/CorePartitioner.d psml/des.d psml/key_gen.d psml/main.d psml/round.d psml/s1.d psml/s2.d psml/s3.d psml/s4.d psml/s5.d psml/s6.d psml/s7.d psml/s8.d psml/tb.d 
clean.OBJ += $(Debug_target.BIN) $(Debug_target.OBJ)

Debug_target : Debug_target.before $(Debug_target.BIN) Debug_target.after_always
Debug_target : CFLAGS += -w -g -march=native  -Os
Debug_target : INCLUDES += -I../../../../Parvicursor 
Debug_target : RCFLAGS += -I../../../../Parvicursor 
Debug_target : LDFLAGS += -lpthread -luuid -ldl -lm -lcryptopp -L../../../../psml/bin/Debug/ -L../../../../xSim2Lib/bin/Debug/ -L../../../../ParvicursorLib/bin/Debug/ -L../../../../Parvicursor/System.Threading/Thread/   
